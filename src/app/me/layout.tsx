...
import NativeAppBackground from "@/components/user/NativeAppBackground";
...
export default async function MeLayout({ children }: { children: React.ReactNode }) {
  const nativeShell = isCapacitorUserAgent((await headers()).get("user-agent"));
