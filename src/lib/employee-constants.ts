// Enum constants for employee fields — used by DB check constraints, API validation, and frontend dropdowns.
// Keep this list in sync with the CHECK constraints in scripts/migrate.js.
